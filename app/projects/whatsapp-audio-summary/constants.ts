...
export const insightsData: InsightItem[] = [
  ...
  {
    icon: getWhatsAppAssetUrl("whtsp_insights_lock.gif"),
  ...
  {
    icon: getWhatsAppAssetUrl("whtsp_insights_mic.gif"),
...
export const uj2Iteration1Images = [
  ...
  getWhatsAppAssetUrl("uj2_itr1_screen3.png"),
  getWhatsAppAssetUrl("uj2_itr1_screen4.png"),
];
...
export const uj2SearchFlowImages = [
  getWhatsAppAssetUrl("uj2_screen1.png"),
  getWhatsAppAssetUrl("uj2_screen2.png"),
  getWhatsAppAssetUrl("uj2_screen3.png"),
  getWhatsAppAssetUrl("uj2_screen4.png"),
  getWhatsAppAssetUrl("uj2_screen5.png"),
];
