...
interface ShaderUniforms {
  [key: string]: { value: number | THREE.Vector2 | THREE.Vector3 | THREE.Vector3[] };
...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    // Set color space if available (Three.js r137+)
    if ("outputColorSpace" in renderer) {
      (renderer as THREE.WebGLRenderer & { outputColorSpace?: string }).outputColorSpace = THREE.SRGBColorSpace || "srgb";
    }
    ...
    if ("ResizeObserver" in window) {
      ...
      resizeObserverRef.current = ro;
        ...
        (globalThis as unknown as Window).addEventListener("resize", handleResize);
      }
